export const experience = [
  {
    ...
    description: (
      <p>
        ...
        manage team schedules, and offer guidance for uninterrupted development.
        I collaborate on API structures with the backend team and review and
        approve pull requests. After QA approval, I handle staging and
        production environment setups and manage defects during sprints.
      </p>
    ),
    badge: [
      "JavaScript",
  ...
  },
  {
    ...
    description: (
      <p>
        In our Scrum methodology, tasks are initiated through ticket creation on
        the Azure board by our Team Lead. Once tasks are assigned, I begin
        ...
        critical as we integrate REST API endpoints into our project. Upon task
        completion, I initiate a Git pull request for peer review and approval.
        If QA identifies bugs within my module, I take ownership by assigning
        myself the ticket for defect resolution. I promptly address issues,
        ensuring fixes progress seamlessly through both development and QA
        phases concurrently.
      </p>
    ),
  ...
  },
  {
    ...
    description: (
      <p>
        ...
        communication. Upon completing development tasks, I handle deploying the
        React application across various hosting platforms such as AWS, Netlify,
        and Vercel to ensure accessibility and functionality
      </p>
    ),
